...
export interface FournisseurOption {
  readonly id: "ollama" | "claude" | "open_a_i" | "gemini" | "mistral" | "nvidia" | "custom";
  readonly label: string;
  readonly hint: string;
  readonly icon: string;
}

/** Grille des sept fournisseurs, jamais un menu déroulant. */
export const FOURNISSEURS: readonly FournisseurOption[] = [
  ...
  { id: "open_a_i", label: "OpenAI", hint: "GPT", icon: "auto_awesome" },
...
export function identifiantProvider(provider: ProviderKind): FournisseurOption["id"] {
...
export function modeleDefaut(id: FournisseurOption["id"]): string {
  switch (id) {
    case "ollama":
      return "llama3.2:3b";
    case "claude":
