...
import type { ImportedResumeAnalysis, ListingAnalysis, ResumeAnalysisRequest, ResumeGenerationRequest, ProfileImportRequest, CoverLetterRequest, ResumeGeneration, ExtractedProfile } from "../model/types";
...
export const aiService = {
  ...
  importProfile: (request: ProfileImportRequest) => ipc<ExtractedProfile>("ai_import_profile", { request }),
