 ...
 * `17`) : elle occupe toute la fenêtre, se ferme par la croix ou `Échap`
 * (`INTERACTIONS.md` §1), et range le travail en colonnes — réglages à gauche, contenu au
 * centre, déroulé à droite quand il y en a un.
 */
    ...
    >
      <header data-tauri-drag-region className="flex h-titlebar flex-none items-center gap-3 border-b border-bd-soft pr-3 pl-[84px]">
        ...
        <p className="flex min-w-0 items-center gap-2 text-ui">
          <span className="text-tx-4">{crumbRoot}</span>
